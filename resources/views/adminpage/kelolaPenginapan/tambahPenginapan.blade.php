...
@section('container')
    <div class="box tambahAkun">
        ...
        <form action="/tambahPenginapan" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-upload">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12  form-group">
                        ...
                        <input type="text" name="namaPenginapan" placeholder="Nama Penginapan" class="form-control"
